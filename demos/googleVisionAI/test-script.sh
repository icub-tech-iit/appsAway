...
export APPSAWAY_IMAGES=${3:-\"icubteamcode/google-vision\"}
export APPSAWAY_VERSIONS=${4:-\"master-stable_master\"}  
...
CUSTOM_PORT=/webcam" >> $HOME/iCubApps/$APPSAWAY_APP_NAME/.env 
