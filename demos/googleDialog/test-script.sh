...
export APPSAWAY_IMAGES=${3:-\"icubteamcode/speech\"}
...
INPUT_BOX=projects/team-code-dev/locations/global/agents/daacb7cc-9707-4c95-bdcb-3ca7d30908db
LANGUAGE_SYNTHESIS_INPUT=en-US
GOOGLE_INPUT=True
GOOGLE_DIALOG_INPUT=True
GOOGLE_SYNTHESIS_INPUT=True
VOICE_NAME_INPUT=en-US-Wavenet-A" >> $HOME/iCubApps/$APPSAWAY_APP_NAME/.env 
