...
export APPSAWAY_IMAGES=\" icubteamcode/blender  dockersamples/visualizer  icubteamcode/blender  icubteamcode/superbuild-icubhead\"
export APPSAWAY_VERSIONS=\"v2022.02.0 stable v2022.02.0 v2022.02.0\"
